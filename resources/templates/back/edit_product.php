...
<!-- enctype is for multifiles inside the form (we have an image)!-->
...
<aside id="admin_sidebar" class="col-md-4">
    ...
    <div class="form-group">
        ...
        <select name="product_category_id" id="" class="form-control">
            <option value="<?php echo $product_category_id; ?>"><?php echo show_product_cat_title($product_category_id); ?></option>
